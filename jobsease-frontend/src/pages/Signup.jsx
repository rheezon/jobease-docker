...
const Signup = () => {
  ...
  useEffect(() => {
    ...
    if (!clientId) {
      setGoogleError('Google sign-up is unavailable. Missing Google client ID configuration.');
      return;
    }
    ...
    if (!initGoogle()) {
      ...
      const timeout = setTimeout(() => {
        ...
        setGoogleError('Google sign-up is unavailable right now. Please refresh and try again.');
      }, 5000);
